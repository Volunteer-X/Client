...
export type CreateUserMutation = { __typename?: 'Mutation', createUser: { __typename?: 'User', id: string, email: string, username: string, picture?: string | null, picks?: Array<string | null> | null, name?: { __typename?: 'Name', firstName: string, lastName: string } | null } };
...
export type GetUserByEmailQuery = { __typename?: 'Query', getUserByEmail?: { __typename?: 'User', id: string, email: string, username: string, picture?: string | null, picks?: Array<string | null> | null, name?: { __typename?: 'Name', firstName: string, lastName: string } | null } | null };
...
export type CreatePingMutation = { __typename?: 'Mutation', createPing: { __typename?: 'Ping', id: string, title: string, description?: string | null, createdAt?: Date | string | null, user?: { __typename?: 'User', id: string, username: string, picture?: string | null, name?: { __typename?: 'Name', firstName: string, lastName: string } | null } | null } };

export type UpdatePingMutationVariables = Exact<{
  updatePingInput: UPingInput;
}>;


export type UpdatePingMutation = { __typename?: 'Mutation', updatePing: { __typename?: 'Ping', id: string, title: string, description?: string | null, createdAt?: Date | string | null, user?: { __typename?: 'User', id: string, username: string, picture?: string | null, name?: { __typename?: 'Name', firstName: string, lastName: string } | null } | null } };
...
export const UpdatePingDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"updatePing"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"updatePingInput"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UPingInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updatePing"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"EnumValue","value":"string"}},{"kind":"Argument","name":{"kind":"Name","value":"payload"},"value":{"kind":"Variable","name":{"kind":"Name","value":"updatePingInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}}]}},{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"picture"}}]}}]}}]}}]} as unknown as DocumentNode<UpdatePingMutation, UpdatePingMutationVariables>;