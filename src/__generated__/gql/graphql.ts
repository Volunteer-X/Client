...
export type CreatePingMutation = {
  __typename?: 'Mutation';
  createPing: { __typename?: 'Ping'; id: string };
};
...
export type GetPingsWithinRadiusQuery = {
  __typename?: 'Query';
...
>;
export const GetAllPingDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetAllPing' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
...
} as unknown as DocumentNode<GetAllPingQuery, GetAllPingQueryVariables>;
            ...
            selectionSet: {
              ...
              selections: [
                ...
                },
                {
                  ...
                  typeCondition: {
                    kind: 'NamedType',
                    name: { kind: 'Name', value: 'InternalServerError' },
                  },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'UPingInput' },
          },
          type: {
            kind: 'NonNullType',
            type: {
...
export const GetPingsWithinRadiusDocument = {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetPingsWithinRadius' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'UPingsWithinRadiusInput' },
            },
          },
        },
        {
  ...
  GetPingsWithinRadiusQuery,
  GetPingsWithinRadiusQueryVariables
>;
