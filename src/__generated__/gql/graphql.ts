...
export type PingFragmentFragment = {
  __typename?: 'Ping';
  id: string;
  title: string;
  description?: string | null;
...
} & { ' $fragmentName'?: 'PingFragmentFragment' };
...
export const PingFragmentFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
...
} as unknown as DocumentNode<PingFragmentFragment, unknown>;
